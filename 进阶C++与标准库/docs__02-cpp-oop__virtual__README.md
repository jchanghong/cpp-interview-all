...
- [一、虚函数表（vtable）的内存布局](#一虚函数表vtable的内存布局)
- [二、单继承下的 vtable](#二单继承下的-vtable)
- [三、多重继承下的 vtable（多个 vptr）](#三多重继承下的-vtable多个-vptr)
- [四、虚析构函数](#四虚析构函数)
- [五、虚函数的性能开销](#五虚函数的性能开销)
- [六、面试真题](#六面试真题)
...
[virtual_demo.cpp](../../../code/02-cpp-oop/virtual_demo.cpp)
